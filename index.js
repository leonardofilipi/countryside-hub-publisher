...
app.use(express.urlencoded({ extended: true })); // para POST /auth/reset (form)
...
// ==== CatFinder JSON (endpoint remoto para o Shopify) =======================
...
// reset (GET mostra form simples; POST aplica)
...
// ==== REVIEWS ================================================================
// criar avaliação (com disparo de recompute)
app.post('/reviews', auth, async (req, res) => {
  ...
  // dispara recompute (não bloqueia a resposta)
  try {
